 ...
 * Description: Control the number of times a subscription can be purchased.
...
function sold_out_template( $templates, $slug, $name ) {
	...
	if ( $sold >= $qty_available ) {
		remove_filter( 'rcp_get_template_part', '\RCP\Addon\LimitedQuantityAvailable\sold_out_template', 10, 3 );
